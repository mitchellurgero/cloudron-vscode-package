...
exports.isFile = exports.canConnect = exports.pathToFsPath = exports.isObject = exports.buildAllowedMessage = exports.enumToArray = exports.open = exports.isWsl = exports.getMediaMime = exports.hash = exports.generatePassword = exports.generateCertificate = exports.humanPath = exports.paths = exports.tmpdir = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all([fs.pathExists(certPath), fs.pathExists(certKeyPath)])];
            case 1:
                checks = _a.sent();
            ...
            case 2:
                certs = _a.sent();
                return [4 /*yield*/, fs.mkdirp(exports.paths.data)];
            case 3:
                _a.sent();
                return [4 /*yield*/, Promise.all([fs.writeFile(certPath, certs.certificate), fs.writeFile(certKeyPath, certs.serviceKey)])];
            case 4:
                _a.sent();
                _a.label = 5;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                proc = cp.spawn(command, __spread(args, [url]), options);
                return [4 /*yield*/, new Promise(function (resolve, reject) {
