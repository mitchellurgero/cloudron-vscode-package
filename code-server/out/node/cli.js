...
exports.optionDescriptions = function () {
    ...
    return entries.map(function (_a) {
        ...
        return (help + ((_b = v.description) === null || _b === void 0 ? void 0 : _b.trim().split(/\n/).map(function (line, i) {
            line = line.trim();
            if (i === 0) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!(args.cert && !args.cert.value)) return [3 /*break*/, 4];
                ...
                readSocketPath = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, fs.readFile(path.join(os.tmpdir(), "vscode-ipc"), "utf8")];
