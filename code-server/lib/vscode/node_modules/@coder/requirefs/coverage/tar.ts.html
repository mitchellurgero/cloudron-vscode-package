...
<html lang="en">
<head>
    <title>Code coverage report for tar.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> tar.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  private static parseHeader(reader: Reader): TarHeader {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (sign === 0xff || sign === 0x80) {
<span class="cstat-no" title="statement not covered" >      throw new Error("base256 encoding not supported")</span>
    }
&nbsp;
    const prefix = reader.jump(345).read(155, "utf8")
    return {
      name: (prefix ? <span class="branch-0 cbranch-no" title="branch not covered" >prefix + "/" </span>: "") + reader.jump(0).read(100, "utf8"),
